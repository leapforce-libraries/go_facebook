...
require (
	...
	github.com/leapforce-libraries/go_integration v0.0.0-20221219180324-1d9ce9d12c4c
...
require (
	...
	github.com/leapforce-libraries/go_utilities v0.0.0-20221202090301-ca2b5b24ae83 // indirect
